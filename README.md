...
| Method   | Path                          | Auth | Description                          |
| -------- | ----------------------------- | ---- | ------------------------------------ |
| `POST`   | `/api/v1/products`            | Yes  | Create a product listing (multipart) |
| `GET`    | `/api/v1/products`            | No   | Get all products                     |
| `GET`    | `/api/v1/products/:id`        | Yes  | Get a single product                 |
| `PUT`    | `/api/v1/products/:id`        | Yes  | Update a product (owner only)        |
| `PATCH`  | `/api/v1/products/:id/status` | Yes  | Toggle availability (owner only)     |
| `DELETE` | `/api/v1/products/:id`        | Yes  | Delete a product (owner only)        |
